<?php $header_style = get_theme_mod('header_style','style1'); ?>

<header class="site-header default header-<?php echo esc_attr($header_style); ?>" role="banner">
    ...
    <div class="navbar navbar-default navbar-static-top">
        <div class="container-fluid">
            ...
            <div class="navbar-collapse collapse" id="main-navbar-collapse">
                ...
                $menu_width = get_theme_mod('menu_width','col-md-4');
                wp_nav_menu(
                    array(
                        'theme_location'    => 'main-menu',
                        'menu_class'        => 'nav '.$is_nav_mobile.' navbar-nav '.$menu_width.'',
