...
$output = $el_class = $img_style_octagon = $img_style_class = $img_style_wrapper_start = $img_style_wrapper_end = $has_magnific = $image = $img_size = $img_link = $img_link_target = $img_link_large = $title = $alignment = $css_animation = '';
