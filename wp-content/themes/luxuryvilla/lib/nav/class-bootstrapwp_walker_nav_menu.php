...
/**
*
* Adapted from Edward McIntyre's gg_bootstrap_navwalker class. 
* Removed support for glyphicon and added support for Font Awesome
*
*/
/**
 * Class Name: gg_bootstrap_navwalker
...
class gg_bootstrap_navwalker extends Walker_Nav_Menu {
    ...
    public function start_el( &$output, $item, $depth = 0, $args = array(), $id = 0 ) {
        ...
        if ( strcasecmp( $item->attr_title, 'divider' ) == 0 && $depth === 1 ) {
            ...
            */
            ...
            if($depth === 0) {
                $menu_columns = get_theme_mod('menu_columns','4');
                $menu_item_cols = floor( 12 / $menu_columns );
                $class_names .= ' col-sm-'.$menu_item_cols.' col-md-'.$menu_item_cols;
            }
            ...
            $output .= $indent . '<li data-toggle="collapse" data-target=".in" ' . $id . $value . $class_names .'>';
