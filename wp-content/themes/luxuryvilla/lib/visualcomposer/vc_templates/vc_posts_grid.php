...
<div class="<?php echo apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $css_class, $this->settings['base']) ?>">
        ...
        <div class="teaser_grid_container">
            ...
            <div class="isotope-filter-content img-rounded">
                ...
                <ul class="categories_filter clearfix nav nav-pills">
                    ...
                    <li class="col-md-2"><a href="#" data-filter=".grid-cat-<?php echo esc_attr($cat->term_id) ?>"><?php echo esc_attr($cat->name); ?></a></li>
                    <?php endforeach; ?>
                </ul>
            </div>
            ...
            <?php endif; ?>
            <ul class="row wpb_thumbnails wpb_thumbnails-fluid clearfix" data-layout-mode="<?php echo esc_attr($grid_layout_mode); ?>">
                ...
                <?php
                    ...
                    ?>
                <li class="isotope-item <?php echo apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $li_span_class, 'vc_teaser_grid_li').$post->categories_css ?>"<?php echo wp_kses_post($block_style); ?>>
                    <?php foreach($blocks_to_build as $block_data): ?>
                        <?php include $this->getBlockTemplate() ?>
                    <?php endforeach; ?>
                </li> <?php echo wp_kses_post($this->endBlockComment('single teaser')); ?>
                <?php endforeach; ?>
                <?php else: ?>
    ...
    <div class="clear"></div>
</div> <?php echo wp_kses_post($this->endBlockComment('.wpb_teaser_grid')); ?>
