...
$css_class = apply_filters( VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, 'row wpb_row vc_row vc_row-fluid'. ( $this->settings('base')==='vc_row_inner' ? 'vc_inner ' : '' ) . $el_class . $parallax_class . $video_class . vc_shortcode_custom_css_class( $css, ' ' ), $this->settings['base'], $atts );
$style = $bg_image.$bg_color.$bg_image_repeat.$padding.$margin_bottom.$text_align_style;
