...
<div class="<?php echo apply_filters(VC_SHORTCODE_CUSTOM_CSS_FILTER_TAG, $css_class, $this->settings['base']) ?>">
    <div class="wpb_wrapper">
        ...
        <div id="<?php echo esc_attr($carousel_id); ?>" data-ride="vc-carousel" data-wrap="<?php echo esc_attr($wrap==='yes' ? 'true' : 'false'); ?>" data-interval="<?php echo esc_attr($autoplay == 'yes' ? $speed : 0); ?>" data-auto-height="true" data-mode="<?php echo esc_attr($mode); ?>" data-partial="<?php echo esc_attr($partial_view === 'yes' ? 'true' : 'false'); ?>" data-per-view="<?php echo esc_attr($slides_per_view); ?>" data-hide-on-end="<?php echo esc_attr($autoplay == 'yes' ? 'false' : 'true'); ?>" class="vc-carousel vc-slide">
            ...
            <div class="vc-carousel-inner">
                ...
                $block_style = isset($post->bgcolor) ? ' style="background-color: '.$post->bgcolor.'"' : '';
                    ?>
                <div class="vc-item vc_slide_<?php echo esc_attr($post->post_type); ?>"<?php echo wp_kses_post($block_style); ?>>
                    <div class="vc-inner">
            ...
            <!-- Controls -->
            <a class="vc-left vc-carousel-control" href="#<?php echo esc_html($carousel_id); ?>" data-slide="prev">
                <span class="icon-prev"></span>
            </a>
            <a class="vc-right vc-carousel-control" href="#<?php echo esc_html($carousel_id); ?>" data-slide="next">
